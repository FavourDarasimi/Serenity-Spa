const HeroSection = () => {
  return (
    <section className="h-[calc(100vh-var(--nav-h))] flex flex-col justify-center items-center bg-gradient-to-b from-white via-stone-100 to-stone-200 px-4">
      <div className="space-y-6 max-w-4xl text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:gap-10 justify-center">
          ...
          <button className="border p-3 rounded-lg text-[17px] w-full md:w-fit hover:scale-105 transition duration-300 tracking-wider">
            Explore Packages
          </button>
        </div>
      </div>
